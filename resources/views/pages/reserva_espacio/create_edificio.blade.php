...
@section('title')
     <h1 class="nav-title text-white"><i class="icon icon-building s-18"></i>Reservas > {{ $edificio->name ?? '' }}</h1>
          ...
          <div class="card-body">
            ...
            <div class="tab-content" id="nav-tabContent">
              <div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-home-tab">
               ...
               <form action="{{ route('reservaEspacio.save') }}" name="form_add" id="accountForm" method="POST" role="form"enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-row">
                    ...
                    <div class="form-row">
                      <div class="form-group col-6 m-0" id="name_group">
                        {!! Form::label('name', __('Edificio*'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}
                          ...
                          {!! Form::select('edificio_id',$buildings, $edificio->id ?? null, ['class'=>'form-control r-0 light select2 s-12', 'id'=>'edificio_id', 'disabled']) !!}

                        {!! Form::hidden('edificio_id',$edificio->id, ['class'=>'form-control r-0 light  s-12', 'id'=>'_edificio_id']) !!}
                       ...
                       <div class="form-group col-6 m-0" id="name_group">
                        ...
                        {!! Form::select('espacio_id',$espacios, null, ['class'=>'form-control r-0 light select2 s-12', 'id'=>'espacio_id']) !!}
                  ...
                  <div class="col-md-6">
                    <div class="form-row">
                      ...
                      <div class="form-group col-12 m-0" id="region_group">
                        ...
                        {!! Form::text('departamento', null, ['class'=>'form-control r-0 light s-12', 'id'=>'asunto']) !!}
                        <span class="region_span"></span>
                      </div>
                      ...
                      <div class="form-group col-6 m-0">
                        ...
                        <input name="fecha_reserva" type="text" class="date-time-picker form-control"
                          data-options='{"timepicker":false, "format":"d-m-Y"}' value=""/>
                      ...
                      <div class="form-group col-3 m-0">
                        {!! Form::label('fecha',__('Hora Inicio*'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}
                          ...
                          {!! Form::time('hora_inicio', null, ['class'=>'form-control ml-1 p-0  light s-12', 'id'=>'hora_inicio']) !!}
                      ...
                      <div class="form-group col-3 m-0">
                        {!! Form::label('fecha',__('Hora Fin*'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}
                          ...
                          {!! Form::time('hora_fin', null, ['class'=>'form-control ml-1 p-0  light s-12', 'id'=>'hora_fin']) !!}
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('observaciones',null, ['class'=>'form-control r-0 light s-12', 'onclick'=>'inputClear(this.id)','rows'=>'8']) !!}
                ...
                <div class="row text-right mt-4">
                  <div class="col-md-12 ">
                    <a href="{{ route('reservaEspacio.index') }}" class="btn btn-default" data-dismiss="modal">{{__('Atrás')}}</a>
