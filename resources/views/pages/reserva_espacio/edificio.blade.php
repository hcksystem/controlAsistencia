...
@section('title')
     ...
     <h1 class="nav-title text-white"><i class="icon icon-building s-18"></i>Reserva > {{ $edificio->name ?? ''}}</h1>
...
<div class="page  height-full">
    ...
    <a href="{{ route('reservaEspacio.createEdificio',$edificio->id) }}" class="btn-fab btn-fab-md fab-right fab-right-bottom-fixed shadow btn-primary" title="Crear Reserva">
        <i class="icon-add"></i>
    </a>
