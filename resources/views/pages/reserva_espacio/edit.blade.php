...
@section('title')
     <h1 class="nav-title text-white"><a href="{{ route('reservaEspacio.index') }}"><i class="icon icon-building s-18"></i>Reservas > {{ $edificio->name ?? '' }}</a></h1>
              ...
              <div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-home-tab">
               ...
               <form action="{{ route('reservaEspacio.update',$reserva->id) }}" method="POST" autocomplete="off">
                ...
                <div class="form-row">
                  <div class="col-md-12">
                    <div class="form-row">
                      <div class="form-group col-6 m-0" id="name_group">
                        ...
                        {!! Form::select('edificio_id',$buildings, $reserva->edificio_id ?? null, ['class'=>'form-control r-0 light select2 s-12', 'id'=>'edificio_id', 'disabled']) !!}

                        {!! Form::hidden('edificio_id',$reserva->edificio_id, ['class'=>'form-control r-0 light  s-12', 'id'=>'_edificio_id']) !!}
                  ...
                  <div class="col-md-6">
                    <div class="form-row">
                        <div class="form-group col-12 m-0" id="status_group">
                          {!! Form::label('status', __('Status*'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}
                    
                        {!! Form::select('id_status',$status, $reserva->id_status ?? null, ['class'=>'form-control r-0 light select2 s-12', 'id'=>'id_status']) !!}
                        <span class="region_span"></span>
                      </div>
                        ...
                        {!! Form::text('telefono', $reserva->telefono ?? null, ['class'=>'form-control r-0 light s-12', 'id'=>'telefono']) !!}
                        <span class="region_span"></span>
                      </div>
                       <div class="form-group col-12 m-0" id="region_group">
                        <i class="icon-globe mr-2"></i>
                      ...
                      <div class="form-group col-6 m-0">
                        ...
                        <input name="fecha_reserva " type="text" class="date-time-picker form-control"
                          data-options='{"timepicker":false, "format":"d-m-Y"}' value="{{ $reserva->fecha_reserva ?? null }}"/>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('observaciones',$reserva->observaciones ?? null, ['class'=>'form-control r-0 light s-12', 'onclick'=>'inputClear(this.id)','rows'=>'8']) !!}
                ...
                <div class="row text-right mt-4">
                  <div class="col-md-12 ">
                    <a href="{{ route('reservaEspacioPorEdificio') }}" class="btn btn-default">{{__('Atrás')}}</a>
