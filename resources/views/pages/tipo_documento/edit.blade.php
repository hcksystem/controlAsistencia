    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"><i class="icon-eye"></i> Editar Tipo</h4>
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-12 m-0" id="name_group">
                                ...
                                {!! Form::text('nombre', null, ['class'=>'form-control r-0 light s-12',  'id'=>'_nombre', 'onclick'=>'inputClear(this.id)']) !!}
