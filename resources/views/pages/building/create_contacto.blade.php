<!-- Modal -->
{!! Form::open(['route'=>'building.store_contact','method'=>'POST', 'class'=>'formlDinamic', 'id'=>'guardarRegistro']) !!}
 {{ csrf_field() }}
<div class="modal fade" id="createContacto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					...
					<div class="col-md-12">
										<div class="form-row">
											<div class="form-group col-6 m-0" id="tipo_group">
												...
												{!! Form::select('tipo_contacto_id',$tipo, null, ['class'=>'form-control r-0 light s-12', 'id'=>'telefono']) !!}
										...
										<div class="form-row">
											...
											<div class="form-group col-6 m-0" id="correo_group">
												...
												{!! Form::email('correo', null, ['class'=>'form-control r-0 light s-12', 'id'=>'correo']) !!}
										...
										{!! Form::hidden('route', route('building.store_contact'), ['id'=>'route']) !!}
					</div>		
				</div>
			</div>
