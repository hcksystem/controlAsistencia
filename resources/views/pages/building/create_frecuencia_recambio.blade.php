<!-- Modal -->
{!! Form::open(['route'=>'edificios.createFrecuenciaRecambio','method'=>'POST', 'enctype' => 'multipart/form-data','files' => true]) !!}
 {{ csrf_field() }}
<div class="modal fade" id="createFrecuenciaRecambio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					...
					<div class="col-md-12">
										<div class="form-row">
											...
											<div class="form-group col-4 m-0" id="name_group">
												...
												{!! Form::month('periodo', null, ['class'=>'form-control r-0 light s-12', 'id'=>'periodo_frecuencia']) !!}
												<span class="name_span"></span>
											</div>
											<div class="form-group col-4 m-0" id="tipo_group">
												{!! Form::label('tipo', __('Recambio'), ['class'=>'col-form-label s-12']) !!}
												{!! Form::number('recambio', null, ['class'=>'form-control r-0 light s-12', 'id'=>'recambio']) !!}
