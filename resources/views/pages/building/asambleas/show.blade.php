...
@section('title')
<h1 class="nav-title text-white"><i class="icon icon-building s-18"></i><a href="{{ route('edificios.asamblea')}}">{{ __('Asambleas')}}</a></h1>
@endsection
                  ...
                  <div class="col-md-12">
                    <div class="form-row">
                      <div class="form-group col-6 m-0" id="name_group">
                        ...
                        {!! Form::select('edificio_id',$buildings, $asamblea->edificio_id ?? null, ['class'=>'form-control r-0 light select2 s-12', 'id'=>'edificio_id']) !!}
