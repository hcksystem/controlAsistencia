<!-- Modal -->
{!! Form::open(['route'=>'edificios.createDocument','method'=>'POST', 'enctype' => 'multipart/form-data','files' => true]) !!}
            ...
            <div class="form-row">
                  <div class="col-4 m-0" id="name_group">
                      <div class="from-group">
                          ...
                          {!! Form::text('nombre', null, ['class'=>'form-control r-0 light s-12', 'id'=>'name']) !!}
                  ...
                  <div class="col-8 m-0" id="name_group">
                      <div class="from-group">
                          ...
                          {!! Form::select('documento_id', $documentType, null, ['class'=>'form-control r-0 light s-12 select2', 'id'=>'documentType']) !!}
