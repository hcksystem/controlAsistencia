									...
									<div class="col-md-8">
										<div class="form-row">
											...
											<div class="form-group col-6 m-0" id="latitude_group" >
												...
												{!! Form::text('latitude', $building->latitude ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'latitude','readonly']) !!}
											...
											<div class="form-group col-6 m-0" id="longitude_group" >
												...
												{!! Form::text('longitude', $building->longitude ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'longitude','readonly']) !!}
											...
											<div class="form-group col-6 m-0" id="telefono_group">
												...
												{!! Form::text('telefono', $building->telefono ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'phone','readonly']) !!}
											...
											<div class="form-group col-12 m-0" id="address_group">
												...
												{!! Form::textarea('address', $building->address ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'address','rows'=>'3','readonly']) !!}
									...
									<div class="col-12 mt-2">
										...
										<div class="fom-row form-group">
											<div class="form-row">
												...
												{!! Form::select('administracion_id',$admin, $building->administracion_id ?? '', ['class'=>'form-control r-0 light select2 s-12', 'id'=>'administracion_id','disabled']) !!}
											...
											<div class="form-row">
												...
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>Sí</b></p>
														<input type="checkbox" id="deuda_luz_yes" name="deuda_luz" value="1" @if($building->deuda_luz == 1){{'checked'}} @endif class="mb-3 ml-2" disabled>
													</div>
												</div>
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>No</b></p>
														<input type="checkbox" id="deuda_luz_no" name="deuda_luz" value="0" @if($building->deuda_luz == 0){{'checked'}}@endif class="mb-3 ml-2"disabled>
													</div>
												...
												<div class="col-md-8">
													<div class="form-inline col-12">
														<p><b>Resolución</b></p>
														{!! Form::text('resolucion_luz',$building->resolucion_luz ?? null, ['class'=>'form-control r-0 light s-12 ml-2', 'id'=>'resolucion_luz','style'=>'width:450px;','readonly']) !!}
													</div>
												</div>
												...
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>Sí</b></p>
														<input type="checkbox" id="deuda_agua_yes" @if($building->deuda_agua == 1){{'checked'}}@endif name="deuda_agua" value="1" class="mb-3 ml-2" disabled>
													</div>
												</div>
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>No</b></p>
														<input type="checkbox" id="deuda_agua_no" @if($building->deuda_agua == 0){{'checked'}}@endif name="deuda_agua" value="0" class="mb-3 ml-2" disabled>
													</div>
												...
												<div class="col-md-8">
													<div class="form-inline col-12">
														<p><b>Resolución</b></p>
														{!! Form::text('resolucion_agua',$building->resolucion_agua ?? null, ['class'=>'form-control r-0 light s-12 ml-2', 'id'=>'resolucion_agua','style'=>'width:450px;','readonly']) !!}
													</div>
												</div>
												...
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>Sí</b></p>
														<input type="checkbox" id="deuda_gas_yes" name="deuda_gas" @if($building->deuda_gas == 1){{'checked'}}@endif  value="1" class="mb-3 ml-2" disabled>
													</div>
												</div>
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>No</b></p>
														<input type="checkbox" id="deuda_gas_no" name="deuda_gas" @if($building->deuda_gas == 0){{'checked'}}@endif  value="0" class="mb-3 ml-2" disabled>
													</div>
												...
												<div class="col-md-8">
													<div class="form-inline col-12">
														<p><b>Resolución</b></p>
														{!! Form::text('resolucion_gas',$building->resolucion_gas ?? null, ['class'=>'form-control r-0 light s-12 ml-2', 'id'=>'resolucion_gas','style'=>'width:450px;','readonly']) !!}
													</div>
												</div>
										...
										<div class="fom-row form-group">
											<div class="form-row">
												...
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>Sí</b></p>
														<input type="checkbox" id="demanda_yes" name="demanda" value="1" @if($building->demanda == 1){{'checked'}} @endif class="mb-3 ml-2" disabled>
													</div>
												</div>
												<div class="col-md-1">
													<div class="form-inline">
														<p><b>No</b></p>
														<input type="checkbox" id="demanda_no" name="demanda" value="0" @if($building->demanda == 0){{'checked'}}@endif class="mb-3 ml-2" disabled>
													</div>
												...
												<div class="col-md-10">
													<div class="form-inline col-12">
														<p><b>Concepto</b></p>
														{!! Form::text('concepto_demanda',$building->resolucion_luz ?? null, ['class'=>'form-control r-0 light s-12 ml-2', 'id'=>'concepto_demanda','style'=>'width:600px;','readonly']) !!}
													</div>
												</div>
									...
									<table class="table ">
						                ...
						                <tr>
						                	<td>{!! Form::label('cantidad_dptos',__('Cantidad de Departamentos'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
						                  	<td>{!! Form::text('cantidad_dptos', $building->cantidad_dptos ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'cantidad_dptos','readonly']) !!}</td>
						                </tr>
						               <tr>
						                	<td>{!! Form::label('cantidad_pisos',__('Cantidad de Pisos'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::text('cantidad_pisos', $building->cantidad_pisos ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'cantidad_pisos','readonly']) !!}</td>	
						                </tr>
						                <tr>
						                	<td>{!! Form::label('cantidad_est',__('Estacionamientos'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::text('cantidad_est', $building->cantidad_est ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'cantidad_est','readonly']) !!}</td>	
						                </tr>
						                <tr>
											...
											<td>{!! Form::text('cantidad_est_visitas', $building->cantidad_est_visitas ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'cantidad_est_visitas','readonly']) !!}</td>	
						                </tr>
						                <tr>
								            <td>{!! Form::label('revestimiento',__('Revestimiento de Murallas'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('revestimiento', $revestimiento, $building->revestimiento ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"revestimiento",'disabled' ]) !!}</td>	
								         </tr>
						              	 <tr>
								            <td>{!! Form::label('cubierta_cocina',__('Cubierta de Cocina'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('cubierta_cocina', $cubierta_cocina, $building->cubierta_cocina ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"cubierta_cocina",'disabled' ]) !!}</td>	
								         </tr>	
								       
						              	 <tr>
								            <td>{!! Form::label('ventanas',__('Ventanas'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('ventanas', $ventanas, $building->ventanas ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"ventanas",'disabled' ]) !!}</td>	
								         </tr>	
								         <tr>
								            <td>{!! Form::label('lavaplatos',__('Lavaplatos'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('lavaplatos', $lavaplatos, $building->lavaplatos ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"lavaplatos",'disabled' ]) !!}</td>	
								         </tr>	
								         <tr>
								            <td>{!! Form::label('alarma',__('Alarma'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('alarma', $alarma, $building->alarma ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"alarma",'disabled' ]) !!}</td>	
								         </tr>	
									...
									<div class="col-md-6 mt-2">
										<div class="form-row">
											...
											<table class="table ">
								              ...
								              <tbody>
								                ...
								                <tr>
													...
													<td>
														{!! Form::text('cantidad_sub', $building->cantidad_sub ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'cantidad_sub','readonly']) !!}</td>	
								                </tr>
								               <tr>
								                	<td>{!! Form::label('gastos_comunes_m2',__('Gastos Comunes'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
													<td>{!! Form::text('gastos_comunes_m2', $building->gastos_comunes_m2 ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'gastos_comunes_m2','readonly']) !!}</td>	
								                </tr>
								                <tr>
								                	<td>{!! Form::label('tipo_piso',__('Tipo de Piso'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
													<td>{!! Form::select('Tipo_piso', $tipo_piso, $building->Tipo_piso ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"data1",'disabled' ]) !!}</td>	
								                </tr>
								                <tr>
													...
													<td><div class="" id="admiten_mascotas_group">
															...
															<div class="material-switch ">
												                <input id="_admiten_mascotas" name="admiten_mascotas" type="checkbox" value="1" @if(isset($building))&& @if($building->admiten_mascotas == 1){{'checked'}}@endif @endif disabled/>
								           ...
								           <tr>
											...
											<td>{!! Form::select('cocina', $cocina, $building->cocina ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"cocina",'disabled' ]) !!}</td>	
								         </tr>
						              	 <tr>
								            <td>{!! Form::label('agua_caliente',__('Agua Caliente'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('agua_caliente', $agua_caliente, $building->agua_caliente ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"agua_caliente",'disabled' ]) !!}</td>	
								         </tr>	
								         <tr>
								            <td>{!! Form::label('cubierta_vanitorio',__('Cubierta de Vanitorio'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('cubierta_vanitorio', $cubierta_vanitorio, $building->cubierta_vanitorio ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"cubierta_vanitorio",'disabled' ]) !!}</td>	
								         </tr>
						              	 <tr>
								            <td>{!! Form::label('calefaccion',__('Calefacción'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}</td>
											<td>{!! Form::select('calefaccion', $calefaccion, $building->calefaccion ?? '', ["class"=>"form-control r-0 light select2 s-12","id"=>"calefaccion",'disabled' ]) !!}</td>	
								         </tr>	
                         ...
                         columns: [
                                   {
									...
									{
                                    "mRender": function ( data, type, row ) {
                                      return '<div class="form-inline text-center" style="margin-left:auto; margin-right:auto;padding-left:30px;"><p>'+row['monto_dpto_pequenno']+'</p><a class="btn btn-default btn-sm ml-2" title="Descargar" onclick=descargarBoleta2('+row['id']+') style="padding: .10rem .4rem;"><i class="icon-download text-info"></i></a></div>'
                                        },
                                        className: 'text-center'
                                    },
									{
                                    "mRender": function ( data, type, row ) {
                                      return '<div class="form-inline text-center" style="margin-left:auto; margin-right:auto;padding-left:30px;"><p>'+row['monto_dpto_grande']+'</p><a class="btn btn-default btn-sm ml-2" title="Descargar" onclick=descargarBoletaDpto('+row['id']+') style="padding: .10rem .4rem;"><i class="icon-download text-info"></i></a></div>'
                                        },
                                        className: 'text-center'
                                    }
                                     ,
