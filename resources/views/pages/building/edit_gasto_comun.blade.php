<!-- Modal -->
{!! Form::open(['route'=>'edificios.updateGastoComun','method'=>'POST', 'enctype' => 'multipart/form-data','files' => true]) !!}
 {{ csrf_field() }}
<div class="modal fade" id="updateGastoComun" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					...
					<div class="col-md-12">
										<div class="form-row">
											...
											<div class="form-group col-4 m-0" id="name_group">
												...
												{!! Form::month('periodo', null, ['class'=>'form-control r-0 light s-12', 'id'=>'_periodo_comun']) !!}
												<span class="name_span"></span>
											</div>
											<div class="form-group col-4 m-0" id="tipo_group">
												{!! Form::label('tipo', __('Monto Dpto pequeño'), ['class'=>'col-form-label s-12']) !!}
												{!! Form::text('monto_dpto_pequenno', null, ['class'=>'form-control r-0 light s-12', 'id'=>'_monto_dpto_pequenno']) !!}
												<span class="tipo_span"></span>
											</div>
											
											<div class="form-group col-4 m-0" id="tipo_group">
												{!! Form::label('tipo', __('Monto Dpto Grande'), ['class'=>'col-form-label s-12']) !!}
												{!! Form::text('monto_dpto_grande', null, ['class'=>'form-control r-0 light s-12', 'id'=>'_monto_dpto_grande']) !!}
												<span class="tipo_span"></span>
											</div>
											<div class="col-5 m-0" id="name_group">
											  ...
											  {!! Form::hidden('edificio_id', $building->id, ['class'=>'form-control r-0 light s-12']) !!}
											   {!! Form::hidden('id', null, ['class'=>'form-control r-0 light s-12','id'=>'id_gasto_comun']) !!}
										</div>
