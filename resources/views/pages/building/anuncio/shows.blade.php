@extends('layouts.app')
@section('title')
<h1 class="nav-title text-white"><i class="icon icon-building s-18"></i><a href="{{ route('getAllAnuncios')}}">{{ __('Anuncios')}}</a></h1>
@endsection
                                ...
                                <table class="table table-hover m-2" id="example" style="font-size: 12px">
                                    ...
                                    <tr class="no-b">
                                        ...
                                        <td>
                                            ...
                                            <h5>{{ $anun->servicio->nombre ?? null }}</h5>
                                        ...
                                        <td>
                                            <span>{{ $anun->edificio->region->name ?? ''}}</span><br>
                                            <span>{{ $anun->edificio->commune->name ?? ''}}</span><br>
                                            <span>{{ $anun->edificio->name ?? ''}}</span>
