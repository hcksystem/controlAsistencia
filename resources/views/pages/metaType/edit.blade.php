    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"><i class="icon-pencil"></i>Editar MetaType</h4>
                ...
                <div class="form-row">
                    <div class="col-md-4">
                        <div class="form-group m-0 has-feedback" id="campo_group">
                            ...
                            {!! Form::text('campo', null, ['class'=>'form-control r-0 light s-12', 'id'=>'_campo', 'onclick'=>'inputClear(this.id)']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group m-0" id="password_group">
                            ...
                            {!! Form::select('requerido', [1=>'Si', 0=>'No'], null, ['class'=>'form-control r-0 light s-12', 'id'=>'_requerido', 'onclick'=>'inputClear(this.id)']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group m-0" id="modulo_group">
                            ...
                            {!! Form::select('moduloID', $modulos, null, ['class'=>'form-control r-0 light s-12', 'id'=>'_modulo', 'onclick'=>'inputClear(this.id)']) !!}
                ...
                <div class="form-row">
                    <div class="col-md-4">
                        <div class="form-group m-0" id="dataType_group">
                            ...
                            {!! Form::select('dataTypeID', $dataTypes, null, ['class'=>'form-control r-0 light s-12', 'id'=>'_dataTypeID', 'onclick'=>'inputClear(this.id)']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group m-0" id="activo_group">
                            ...
                            {!! Form::select('activo', [1=>'Si', 0=>'No'], null, ['class'=>'form-control r-0 light s-12', 'id'=>'_activo', 'onclick'=>'inputClear(this.id)']) !!}
                            <span class="code_span"></span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group m-0 has-feedback" id="orden_group">
                            ...
                            {!! Form::text('orden', null, ['class'=>'form-control r-0 light s-12', 'id'=>'_orden', 'onclick'=>'inputClear(this.id)']) !!}
