...
@section('title')
<h1 class="nav-title text-white"><i class="icon icon-building s-18"></i><a href="{{ route('corredor.index')}}">{{ __('Corredores')}}</a> > {{ $corredor->nombre ?? "" }}</h1>
@endsection
                                ...
                                <div class="form-row">
                                    <div class="col-md-9">
                                        <div class="form-row">
                                            <div class="form-group col-6 m-0" id="name_group">
                                                ...
                                                {!! Form::text('nombre', $corredor->nombre ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'nombre']) !!}
                                                @else
                                                   {!! Form::text('nombre', $corredor->nombre ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'nombre','readonly']) !!}
                                                @endif
                                            ...
                                            <div class="form-group col-6 m-0" id="identification_group">
                                                ...
                                                @if(!Auth::user()->hasRole('copro'))
                                                  {!! Form::text('telefono', $corredor->telefono ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'telefono']) !!}
                                                 @else
                                                   {!! Form::text('telefono', $corredor->telefono ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'telefono','readonly']) !!}
                                                @endif
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-6 m-0" id="contacto_group">
                                                ...
                                                @if(!Auth::user()->hasRole('copro'))
                                                  {!! Form::text('contacto', $corredor->contacto ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'contacto']) !!}
                                                 @else
                                                    {!! Form::text('contacto', $corredor->contacto ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'contacto','readonly']) !!}
                                                @endif
                                                <span class="contacto_span"></span>
                                            </div>
                                            <div class="form-group col-6 m-0" id="trayectoria_group">
                                                <i class="icon-web mr-2"></i>
                                                {!! Form::label('trayectoria', __('Identificación'), ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}
                                                @if(!Auth::user()->hasRole('copro'))
                                                  {!! Form::text('identificacion', $corredor->identificacion ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'identificacion']) !!}
                                                @else
                                                    {!! Form::text('identificacion', $corredor->identificacion ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'identificacion','readonly']) !!}
                                                @endif
                                                {!! Form::hidden('id', $corredor->id ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'_id']) !!}
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="form-group col-1 mt-2" id="name_group" style="margin-left:-15px;">
                                                {!! Form::text('cant_ciudades_disponible', floatval($corredor->cant_ciudades - $cant_ciudades ), ['class'=>'form-control r-0 light s-12 mt-4','style'=>'padding:0px !important','id'=>'cant_ciudades_disponible','readonly']) !!}
                                          ...
                                          @endif
                                           <div class="form-group col-12 mt-4" id="status_group">
                                            ...
                                            <div class="form-group col-12 m-0" id="address_group">
                                                ...
                                                @if(!Auth::user()->hasRole('copro'))
                                                  {!! Form::textarea('direccion', $corredor->direccion ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'direccion', 'rows'=>2]) !!}
                                                @else
                                                   {!! Form::textarea('direccion', $corredor->direccion ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'direccion', 'rows'=>2,'readonly']) !!}
                                                @endif
                                            ...
                                            <div class="form-group col-12 m-0" id="address_group">
                                                ...
                                                @if(!Auth::user()->hasRole('copro'))
                                                  {!! Form::textarea('descripcion', $corredor->descripcion ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'descripcion', 'rows'=>4]) !!}
                                                @else
                                                   {!! Form::textarea('descripcion', $corredor->descripcion ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'descripcion', 'rows'=>4,'readonly']) !!}
                                                @endif
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            @else
                                                  <input id="file" class="file copropietario" name="logo" type="file" readonly="true">
                                            @endif
                                            
                                            {!! Form::hidden('ruta',$corredor->logo ?? '', ['class'=>'form-control r-0 light s-12', 'id'=>'_url_imagen']) !!}
                                  ...
                                  <div class="form-group col-12 m-0" id="contacto_group">
                                    ...
                                    {!! Form::text('cant_ciudades', $corredor->cant_ciudades ?? null, ['class'=>'form-control r-0 light s-12', 'id'=>'cant_ciudades','onkeypress'=>'return soloNumeros(event)']) !!}
                                    @else
                                    {!! Form::text('cant_ciudades', $corredor->cant_ciudades ?? null, ['class'=>'form-control r-0 light s-12', 'id'=>'cant_ciudades','onkeypress'=>'return soloNumeros(event)','readonly']) !!}
                                    @endif
                                    <span class="contacto_span"></span>
                                </div>
                                <br>
...
<script>
        ...
        function actualizarCorredor(id){ 

             var url = "{{ url('updateCorredor') }}/"+id;
             ...
             $.ajax({
                    ...
                    success: function (data) {
                      ...
                      location.reload();
                      toastr.success('Corredor editado correctamente!');
                    },
                    error: function (data){
  ...
  function checkComuna(){
    var id = $('#_id').val();
    var url ="{{url('countComunaCorredor')}}";
    var count = 0;
    $.ajax({
            type : 'get',
            url  : url,
  ...
  function addComuna(){
    ...
    if(cant_ciudades_disponibles > 0){
      ...
      var id_corredor = $('#_id').val();
        var formData = {
                  "id_comuna" : id_comuna,
                  "id_corredor" : id_corredor
          }
         var url ="{{url('addComunaForCorredor')}}";
   ...
   function refrescarSelect(id){
        ...
        var formData = {
         ...
         var url ="{{url('obtenerComunaCorredor')}}";
