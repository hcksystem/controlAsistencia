...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadIcon: '<i class="icon-file_upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="icon-cloud_download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="icon-zoom_out_map"></i>',
                    ...
                    indicatorSuccess: '<i class="glyphicon icon-check text-success"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="icon-navigate_next"></i>',
            next: '<i class="icon-navigate_before"></i>',
            toggleheader: '<i class="icon-arrows-v"></i>',
            fullscreen: '<i class="icon-fullscreen"></i>',
            borderless: '<i class="icon-expand"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        dropZoneClickTitle: '<br>(o haga clic para seleccionar archivo)',
